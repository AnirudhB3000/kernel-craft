/**
 * \file example_conv_naive.cpp
 * \brief Example: Basic naive convolution on GPU.
 *
 * Demonstrates how to use the naive convolution kernel to convolve
 * an input image with a kernel. Compares against CPU for verification.
 */
